...
public class GetWebsiteContentBean {
    ...
    @SerializedName("data")
    private WebsiteContentDataBean data;
    ...
    public WebsiteContentDataBean getData() {
        return data;
    }

    public void setData(WebsiteContentDataBean data) {
        this.data = data;
    }

...
import com.flytrom.learning.custom_views.player.Utilities;
...
public class VdoPlayerControlView extends FrameLayout {
    ...
    public VdoPlayerControlView(Context context, AttributeSet attrs, int defStyle) {
        ...
        LayoutInflater.from(context).inflate(R.layout.partial_vdo_control_view, this);
    ...
    /**
     * Call if fullscreen in entered/exited in MyPojo to external triggers such as orientation
    ...
    private void updateSpeedControlButton() {
        ...
        if (player != null && player.isSpeedControlSupported()) {
            ...
            chosenSpeedIndex = Utilities.getClosestFloatIndex(allowedSpeedList, speed);
    ...
    private final class UiListener implements VdoPlayer.PlaybackEventListener,
        ...
        public void onProgress(long millis) {
            positionView.setText(Utilities.digitalClockTime((int)millis));
        ...
        public void onLoaded(VdoPlayer.VdoInitParams vdoInitParams) {
            durationView.setText(String.valueOf(Utilities.digitalClockTime((int)player.getDuration())));

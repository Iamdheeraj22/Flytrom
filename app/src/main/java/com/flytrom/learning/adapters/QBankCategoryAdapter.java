...
public class QBankCategoryAdapter extends RecyclerView.Adapter<QBankCategoryAdapter.ViewHolder> {
    ...
    public QBankCategoryAdapter(List<DataCategory> regionLodelsList, Context context,OnItemClickListnerBank callBackNew) {
    ...
    @NotNull
    @Override
    public QBankCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View listItem= layoutInflater.inflate(R.layout.qbank_items, parent, false);
        QBankCategoryAdapter.ViewHolder viewHolder = new QBankCategoryAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull QBankCategoryAdapter.ViewHolder holder, int position) {
        ...
        holder.rlCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                callBackNew.onitemClickBankNew(regionLodelsList.get(position).getId(),regionLodelsList.get(position)
                        .getTotal_subjects(),regionLodelsList.get(position).getImage(),regionLodelsList.get(position).getTitle());
            }
        });
    }
